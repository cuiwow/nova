...
class ComputeTestCase(BaseTestCase):
    ...
    def test_check_can_live_migrate_works_correctly(self):
        ...
        db.instance_get_by_uuid(context, inst_uuid).AndReturn(inst_ref)
        self.compute.driver.check_can_live_migrate(context, inst_ref, dest,
                                                   True, False)

        self.mox.ReplayAll()
        self.compute.check_can_live_migrate(context, inst_uuid,
                                            dest, True, False)
    ...
    def test_pre_live_migration_instance_has_no_fixed_ip(self):
        ...
        self.assertRaises(exception.FixedIpNotFoundForInstance,
                          self.compute.pre_live_migration, context, inst_uuid)
    ...
    def test_pre_live_migration_works_correctly(self):
        ...
        # start test
        self.mox.ReplayAll()
        ret = self.compute.pre_live_migration(c, inst_uuid)
    ...
    def test_live_migration_dest_raises_exception(self):
        ...
        self.assertRaises(rpc_common.RemoteError,
                          ...
                          c, inst_uuid, inst_ref['host'], True)
    ...
    def test_live_migration_works_correctly(self):
        ...
        # start test
        self.mox.ReplayAll()
        ret = self.compute.live_migration(c, inst_uuid, inst_ref['host'])
        self.assertEqual(ret, None)
    ...
    def test_post_live_migration_working_correctly(self):
        ...
        db.instance_update(c, i_uuid,
                           {'task_state': task_states.MIGRATING,
                            'power_state': power_state.PAUSED})
        v_ref = db.volume_create(c, {'size': 1, 'instance_id': i_id})
        ...
        rpc.call(c, rpc.queue_get_for(c, FLAGS.compute_topic, dest),
            {"method": "post_live_migration_at_destination",
             "args": {'instance_uuid': i_uuid, 'block_migration': False},
             "version": compute_rpcapi.ComputeAPI.RPC_API_VERSION}, None)
